...
def invoice_detail(inv_id: int, status: str, inv_number: str) -> InlineKeyboardMarkup:
    ...
    kb.row(
        InlineKeyboardButton(text="🗑 حذف",          callback_data=f"inv:del:{inv_id}"),
...
def settings_menu() -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(
        InlineKeyboardButton(text="🏢 نام شرکت", callback_data="set:company"),
        InlineKeyboardButton(text="📞 تلفن",     callback_data="set:phone")
    )
    kb.row(
        InlineKeyboardButton(text="📍 آدرس",     callback_data="set:address"),
        InlineKeyboardButton(text="🌐 وب‌سایت",  callback_data="set:website")
    )
    kb.row(InlineKeyboardButton(text="🖼 لوگوی شرکت", callback_data="set:logo"))
    kb.row(InlineKeyboardButton(text="🔙 منوی اصلی",  callback_data="nav:main"))
    return kb.as_markup()
